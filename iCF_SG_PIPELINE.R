  ...
  if (round(HTE_P_cf.raw,1) <= 0.1){
    ...
    if (length(unique(dat$Y)) >=8){
      ...
      grp_pick.act =which.min(c(#mse_all_folds.m.act,  
        mse_all_folds.g2.act,  mse_all_folds.g3.act,  mse_all_folds.g4.act))
      grp_pick.tran=which.min(c(#mse_all_folds.m.tran, 
        mse_all_folds.g2.tran, mse_all_folds.g3.tran, mse_all_folds.g4.tran))
      
      
      grp_CV_pick_D.act   <- PICK_m234(P_all_folds.mean, mse_all_folds.m.act,  mse_all_folds.g2.act,  mse_all_folds.g3.act,  mse_all_folds.g4.act)
