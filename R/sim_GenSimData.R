...
#' @param m the model of event Y (binary outcome), m = A + B*X
#' 
...
#  Y_binary_int <- a9*a*X3 + a8*a*X1 + a_5_9*a*X9 +  a10*X1*X3  + a11*a*X1*X3  + a_5_1_9*a*X1*X9  + a_5_8_9*a*X8*X9 + a_5_3_9*a*X3*X9  + a12*a*X8 + a13*X1*X8 + a14*X3*X8 + a_5_19*X1*X9 + a_5_89*X8*X9 + + a_5_39*X3*X9  + a15*a*X1*X8  + a16*a*X3*X8  + a17*X1*X3*X8  + a_5_139*X1*X3*X9  + a_5_189*X1*X8*X9 + a_5_389*X3*X8*X9 + a18*a*X1*X3*X8 + a_5_1_3_8_9*a*X1*X3*X8*X9 
...
#' @param a_5_1_3_9 coefficient for W:X1:X3:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_1_8_9 coefficient for W:X1:X8:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_3_8_9 coefficient for W:X3:X8:X9, non-zero when adding 5-way interaction, otherwise 0
...
#' @param a_5_9 coefficient for W:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_1_9 coefficient for W:X1:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_8_9 coefficient for W:X8:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_3_9 coefficient for W:X3:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_1_3_8_9 coefficient for W:X1:X3:X8:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_19 coefficient for X1:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_89 coefficient for X8:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_39 coefficient for X3:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_139 coefficient for X1:X3:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_189 coefficient for X1:X8:X9, non-zero when adding 5-way interaction, otherwise 0
#' @param a_5_389 coefficient for X3:X8:X9, non-zero when adding 5-way interaction, otherwise 0
...
#' @export
#
GEN_SIM_DATA_HTE <- function(scenario, intTRUE, outcome_type, #a8,	  a9,	  a10,  a11,   a12, a12_, a13, a13_, a14, a14_,  a15, a15_, a16, a16_, a17, a17_, a18, a18_, a21, a22, a23, a2s2, a4s2, a1i3, a2i4, a2i3, a3i4, 
                             #a_5_1_3_9, a_5_1_8_9, a_5_3_8_9, a_5_9, a_5_1_9, a_5_8_9, a_5_3_9, a_5_1_3_8_9, a_5_19, a_5_89, a_5_39, a_5_139, a_5_189, a_5_389, 
                            # β_1	β_2	β_3	β_8	β_9	β_1,2	β_1,3	β_1,8	β_2,3	β_3,8	β_1,9	β_8,9	β_3,9	β_1,2,3	β_1,3,8	β_1,3,9	β_(1,8,9) β_3,8,9	β_(1,3,8,9)
                              B1, B2, B3, B8, B9, B1_2, B1_3, B1_8, B2_3, B3_8, B1_9, B8_9, B3_9, B1_2_3, B1_3_8, B1_3_9, B1_8_9,  B3_8_9, B1_3_8_9,  
                             #α_1,2 α_1,3	α_1,8	α_2,3	α_3,8	α_1,9	α_8,9	α_3,9
                             A1_2, A1_3,  A1_8, A2_3, A3_8, A1_9, A8_9, A3_9,
                             nstudy, seed=NULL) {
...
#___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________	  
 ...
 # Y_binary_int <- a9*a*X3   + a8*a*X1    + a_5_9*a*X9 +  a10*X1*X3       + a11*a*X1*X3      + a_5_1_9*a*X1*X9  + a_5_8_9*a*X8*X9 + a_5_3_9*a*X3*X9  + a12*a*X8   + a13*X1*X8      + a14*X3*X8     + a_5_19*X1*X9    + a_5_89*X8*X9    + a_5_39*X3*X9    + a15*a*X1*X8      + a16*a*X3*X8      + a17*X1*X3*X8         + a_5_139*X1*X3*X9     + a_5_189*X1*X8*X9    + a_5_389*X3*X8*X9    + a18*a*X1*X3*X8       + a_5_1_3_9*a*X1*X3*X9 + a_5_1_8_9*a*X1*X8*X9 + a_5_3_8_9*a*X3*X8*X9  + a_5_1_3_8_9*a*X1*X3*X8*X9 
  Y_binary_int   <-                                                       A1_3*X1*X3   + A1_8*X1*X8 + A1_9*X1*X9  + A3_8*X3*X8  + A3_9*X3*X9  + A8_9*X8*X9   
  
  Y_binary_int_W <- B1*a*X1 + B3*a*X3 + B8*a*X8 +  B9*a*X9  + B1_3*a*X1*X3 + B1_8*a*X1*X8 + B1_9*a*X1*X9 + B3_8*a*X3*X8 + B3_9*a*X3*X9 + B8_9*a*X8*X9  + B1_3_8*a*X1*X3*X8  + B1_3_9*a*X1*X3*X9 + B1_8_9*a*X1*X8*X9 + B3_8_9*a*X3*X8*X9  + B1_3_8_9*a*X1*X3*X8*X9 
 ...
 # Y_nonbinary_int <- a21*a*(X2>1)    + a22*(X2>1)*X3         + a23*a*(X2>1)*X3   + a12_*a*(X2>1)   + a13_*X1*(X2>1)   + a14_*X3*(X2>1)   + a15_*a*X1*(X2>1)       + a16_*a*X3*(X2>1)    + a17_*X1*X3*(X2>1)   + a18_*a*X1*X3*(X2>1)
  ...
  Y_nonbinary_int <- B2*a*(X2>1) + A2_3*(X2>1)*X3 + B2_3*a*(X2>1)*X3 + A1_2*X1*(X2>1) + B1_2*a*X1*(X2>1) + B2_3*a*X3*(X2>1) + B1_2_3*a*X1*X3*(X2>1)
  
  } else if ( stringr::str_sub(intTRUE, -1, -1) == "l"){
  #X2 is a continuous variables
 ...
 # Y_nonbinary_int <- a21*a*(X2>0.5)   + a22*(X2>0.5)*X3      + a23*a*(X2>0.5)*X3   + a12_*a*(X2>0.5) + a13_*X1*(X2>0.5)   + a14_*X3*(X2>0.5) + a15_*a*X1*(X2>0.5)  + a16_*a*X3*(X2>0.5) + a17_*X1*X3*(X2>0.5) + a18_*a*X1*X3*(X2>0.5)
  Y_nonbinary_int <- B2*a*(X2>0.5) + A2_3*(X2>0.5)*X3 + B2_3*a*(X2>0.5)*X3  + A1_2*X1*(X2>0.5)  + B1_2*a*X1*(X2>0.5) + B2_3*a*X3*(X2>0.5)  + B1_2_3*a*X1*X3*(X2>0.5)
  ...
  #non-linearity: add square term
 # Y_nonline <- a2s2*X2*X2 + a4s2*X4*X4
  #non-additivity: add interaction term, didn't test in simulation, worry about it later.
#  Y_nonadit <- a1*a1i3*X1*X3 + a2*a2i4*X2*X4 + a2*a2i3*X2*X3 + a3*a3i4*X3*X4
  #sum to get final outcome model
 Y_hte =  Y_binary_int +  Y_binary_int_W + Y_nonbinary_int # + Y_nonline + Y_nonadit
  ...
  #===================================================================================================
  #binary outcome: for simplicity, the simulation will use continuous outcome!!!
  #===================================================================================================
#interacept a=0.01 to replace  original value - 3.85, if negative, e.g. even -0.1, it is very likely to get a negative probability
