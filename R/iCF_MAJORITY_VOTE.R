...
MAJORITY_VOTE <- function(list0, #original list of trees
  ...
  #first things first: get ncol to automatically distinguish among tree(nclol=6), tree_r(ncol=5, "tree_r" stands for "tree relax", i.e., without "spliting value"), or subgroup (ncol=2) input
