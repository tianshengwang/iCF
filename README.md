...
Note the outcome Y should be on **risk difference** scale. For example, based on a **risk difference** scale, only 2 (Patient 1 & 4) out of the following 6 patients had heart failure hospitalization (black dot) in a 2-year period.
