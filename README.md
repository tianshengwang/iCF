...
invisible(lapply(c( "MASS","grf","tidyverse","rlang","rlist","plyr","caret","caTools", "randomForest","data.table",
                    "grid","broom","rstatix","knitr","ggplot2", "ggridges","glmnet","DiagrammeR","pROC"), library, character.only = TRUE))
```
**2. Installation**
