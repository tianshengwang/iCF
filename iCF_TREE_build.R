...
#' @param initial intially tried value (the denominator of N/initial, e.g. N/25 for D2 tree, initial=25
...
LEAFSIZE_tune <- function(Ntrain, initial_D2, treeNo, iterationNo){
  ...
  D5_tune <- GRID_LEAFSIZE(5, initial_D2*4, iCF_D5_BT_exp_SG_D_mean, 10)
