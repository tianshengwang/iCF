...
source("/nas/longleaf/home/tianwang/iCF/programs/macros/GenSimData.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/best_tree_MSegar.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/TREE_build.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/PARENT_node.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/PRE_majority.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/Truth_tree.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/MAJORITY_VOTE.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/SUBGROUP_DECISION.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/SG_PIPELINE.R")
source("/nas/longleaf/home/tianwang/iCF/programs/macros/SUBGROUP_ANALYSIS.R")
#Interaction trees
...
if (length(unique(Y)) >=8){
  ...
  btree_it <- prn.result$btree[[1]] #false negative for 2W
...
#       iCF CV
#---------------------------------------------------------------------------------------------
iCFCV_SG <- iCFCV(10, treeNo, iterationNo)
...
sim.function('A', '4W_Ant_Mo_bbo4',"NoUCCV", "continuous", 0.4,  0.6,  0.4,  0.4,  0,   0.4,  0,  0.4,  0,   0.4,  0,   0.4,  0,   0.4,  0,   0.4,  0,   0.4,    0,  0,   0,    0,     0,   0,     0,     0,     0,     200,   50,           1,   1,   10000,  1) #work!
